...
- Slice 6: Play History, Undo latest eligible action, staged earlier defensive pitch edit/deletion, completed defensive Ball In Play correction including multi-out and classified third-out plays, and atomic multi-change repair of invalid downstream defensive pitches or eligible play results are delivered. Broader play deletion and pitch-total correction remain later work on the correction boundary.
