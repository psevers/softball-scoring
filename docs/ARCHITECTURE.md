...
- Slice 6: Play History, Undo latest eligible action, and staged earlier non-terminal defensive pitch edit are delivered. Earlier-event delete, broader edit coverage, and pitch-total reconciliation remain later work on the correction boundary.
