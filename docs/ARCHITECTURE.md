...
- Slice 6: Play History, Undo latest eligible action, staged earlier non-terminal defensive pitch edit, and staged earlier defensive pitch deletion are delivered. Broader edit/delete coverage and pitch-total reconciliation remain later work on the correction boundary.
