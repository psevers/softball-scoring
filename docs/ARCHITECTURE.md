...
- Slice 6: Play History, Undo latest eligible action, staged earlier defensive pitch edit/deletion, completed single-out/non-third-out defensive Ball In Play correction including runs and RBI, and atomic multi-change repair of invalid downstream defensive pitches or eligible play results are delivered. Multi-out, third-out, broader delete, and pitch-total correction remain later work on the correction boundary.
