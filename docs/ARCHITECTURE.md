...
- Slice 6: Play History, Undo latest eligible action, staged earlier defensive pitch edit/deletion, completed non-scoring defensive Ball In Play correction, and atomic multi-change repair of invalid downstream defensive pitches or eligible non-scoring play results are delivered. Scoring-play, multi-out, third-out, broader delete, and pitch-total correction remain later work on the correction boundary.
