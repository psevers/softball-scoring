...
- Slice 6: Play History, Undo latest eligible action, staged earlier non-terminal defensive pitch edit/deletion, and atomic multi-change repair of invalid downstream defensive pitches are delivered. Broader edit/delete coverage and pitch-total reconciliation remain later work on the correction boundary.
