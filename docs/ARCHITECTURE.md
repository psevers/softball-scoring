...
- Slice 6: read-only Play History and Undo latest eligible defensive action, including terminal ball four, strike three, HBP, and completed Ball In Play results, are delivered; earlier-event edit/delete and pitch-total reconciliation remain later work on the correction boundary.
